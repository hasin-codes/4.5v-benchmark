...
export function VisualPositioningSection({ title, subtitle, scenarios, isDarker = false }: { title: string, subtitle: string, scenarios: VisualPositioningScenario[], isDarker?: boolean }) {
    return (
        <section className={`space-y-16 ${isDarker ? '' : ''}`}>
            ...
            <div className="grid grid-cols-1 gap-24">
                {scenarios.map((scenario) => (
                    <VisualPositioningCard key={scenario.id} scenario={scenario} />
                ))}
            </div>
        </section>
    );
        ...
        <div className="group relative">
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-baseline gap-4">
                    <span className="font-mono text-xs text-blue-500/80 uppercase tracking-wider">Test Case</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative p-6 rounded-2xl bg-[#0A0A0A] border border-white/5 min-h-[120px] flex flex-col justify-between group/response hover:border-white/10 transition-colors">
                                {renderOutput(scenario.averageOutput, 'markdown')}
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3 pb-4 border-b border-white/5">
                            ...
                            <h4 className="text-sm font-medium tracking-widest uppercase text-blue-200/70">Power User</h4>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            {/* AI Response */}
                            <div className="relative p-6 rounded-2xl bg-[#0A0A0A] border border-white/5 min-h-[120px] flex flex-col justify-between group/response hover:border-blue-500/20 transition-colors">
                                {renderOutput(scenario.powerOutput, scenario.outputType)}
                                <div className="mt-4 flex justify-between items-end">
                                    <span className="text-[10px] text-white/20 uppercase tracking-widest">Z.ai Response</span>
                                    <TestScore
                                        score={scenario.testScore}
